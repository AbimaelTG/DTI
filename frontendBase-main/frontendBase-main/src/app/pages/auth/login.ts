                    ...
                    <div class="flex flex-col justify-center grow">
                        <div class="max-w-md mx-auto w-full">
                            ...
                            <form [formGroup]="loginForm" (ngSubmit)="onLogin()">
                                <input type="text" formControlName="usuario" pInputText class="w-full" placeholder="Usuario" required />
...
export class Login {
    ...
    onLogin() {
        ...
        this.loginUsuario = new LoginUsuario(this.usuario.value, this.password.value);
