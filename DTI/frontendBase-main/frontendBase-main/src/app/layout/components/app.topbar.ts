            ...
            <ul class="topbar-menu">
                ...
                <li class="profile-item static sm:relative">
                    <a class="right-sidebar-button relative z-50" pStyleClass="@next" enterFromClass="hidden" enterActiveClass="animate-scalein" leaveActiveClass="animate-fadeout" leaveToClass="hidden" [hideOnOutsideClick]="true">
                        ...
                        <span class="ml-2 label-small text-surface-950 dark:text-surface-0">{{ nombreUsuario() }} </span>
                    </a>
                    <div
                    ...
                    >
                        <ul class="flex flex-col gap-1">
                            <li>
                                <a (click)="onLogOut()" class="label-small dark:text-surface-400 flex gap-2 py-2 px-2.5 rounded-lg items-center hover:bg-emphasis transition-colors duration-150 cursor-pointer">
...
export class AppTopbar {
    ...
    nombreUsuario=computed(() => this._tokenService.getNameUser() || '');
