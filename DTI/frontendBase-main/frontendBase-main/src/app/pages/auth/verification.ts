            ...
            <div class="flex flex-col py-20 lg:min-w-120">
                ...
                <div class="flex flex-col justify-center grow">
                    <div class="max-w-md mx-auto w-full">
                        ...
                        <p class="body-small mt-3.5 text-center lg:text-left">We have sent a code to your email: <span class="text-primary">{{user.email}}</span></p>
                        <form class="mt-8" (ngSubmit)="submitVerification()">
                            <p-input-otp [(ngModel)]="value" [length]="6" [ngModelOptions]="{standalone: true}" class="w-full!" />
...
export class Verification {
    ...
    submitVerification() {
        // Aquí llamarás a tu backend para validar el OTP
        console.log("Email:", this.user.email, "OTP:", this.value);
    }
}
