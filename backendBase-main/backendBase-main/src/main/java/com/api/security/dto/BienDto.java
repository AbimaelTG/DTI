...
public class BienDto implements Serializable {
    ...
    public BienDto(Long id, String codigoInventario, String descripcion, String marca, String modelo, String noSerie,
            String estado, Integer idCategoria, Integer idDependencia, LocalDate fechaAlta, LocalDate fechaBaja) {
