...
public class CategoriaController {
    ...
    public ResponseEntity<?> store(@RequestBody TcCategoria categoria, BindingResult bindingResult) {
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody TcCategoria category,
